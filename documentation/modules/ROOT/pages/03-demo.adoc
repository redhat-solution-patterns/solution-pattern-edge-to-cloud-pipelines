...
:demo-tile-url: https://catalog.demo.redhat.com/catalog?item=babylon-catalog-prod/sandboxes-gpte.com-edge-to-core.prod&utm_source=webapp&utm_medium=share-link
...
+
--
* {demo-tile-url}[**Solution Pattern - Edge to Core Data Pipelines for AI/ML**^]
+
image:29-rhdp-card.jpg[,30%,link={demo-tile-url}, window=_blank]
+
[NOTE]
=====
