...
To initiate the training process, the Shopper application includes a hidden administrative page from where you can trigger it.

Use the following command to obtain the app's admin URL address:
...
Copy the resulting URL address and use it in a new tab in your computer's laptop.

A monitoring view will display showing all the playing parts in the demo. You will already be familiar with most of the parts shown on the monitoring view:
